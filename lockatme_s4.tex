...
Lockatme se découpe en plusieurs fichier. Le fichier __main__.py est un fichier
...
Le fichier lock.py contient la fonction de locking qui fait appel à Xlib.
