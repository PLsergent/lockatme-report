...
opté pour le multi-threading pour utiliser moins de ressources.
la communication entre les modules et le programme principal (contrairement au
multi-processing) sans compliquer le code comme le ferait les coroutines.
